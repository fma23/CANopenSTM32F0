...
static CO_SDO_abortCode_t CO_ODF_RPDOmap(CO_ODF_arg_t *ODF_arg)
{
    ...
    if(ODF_arg->subIndex == 0)
    {
        ...
        /* configure mapping */
        return CO_RPDOconfigMap(RPDO, *value);    // FARID to remove warnings
    }
    ...
    else
    {
        ...
        return CO_PDOfindMap(    // FARID to remove warnings
                RPDO->SDO,
               *value,
                0,
               &pData,
...
static CO_SDO_abortCode_t CO_ODF_TPDOmap(CO_ODF_arg_t *ODF_arg)
{
    ...
    if(ODF_arg->subIndex == 0)
    {
        ...
        /* configure mapping */
        return CO_TPDOconfigMap(TPDO, *value);    // FARID to remove warnings
    }
